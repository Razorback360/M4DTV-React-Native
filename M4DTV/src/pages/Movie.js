...
const MovieScreen = ({ navigation, route }) => {
    ...
    return (
        ...
        <ImageBackground imageStyle={{ opacity: 0.3 }} source={{ uri: `https://image.tmdb.org/t/p/original${movie.backdrop_path}` }} style={styles.backgroundImage}>
            <View style={styles.mainContainer}>
                <View style={styles.posterContainer}>
                    <Image source={{ uri: `https://image.tmdb.org/t/p/original${movie.poster_path}` }} style={styles.poster} resizeMode='contain'></Image>
                </View>
                <View style={styles.informationContainer}>
                    ...
                    <View style={styles.extrasContainer}>
                        ...
                        <Text style={styles.extras}> {movie.release_date.slice(0, 4)} • </Text>
                        <Icon name='clock-time-four-outline' style={styles.icons}></Icon>
                        <Text style={styles.extras}> {Math.floor(movie.runtime / 60)}h{movie.runtime % 60}m • </Text>
