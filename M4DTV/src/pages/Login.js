...
const LoginScreen = ({ navigation }) => {
    ...
    return (
        <LinearGradient
            ...
            <View style={{ backgroundColor: "#000000", width: "25%", height: "50%", borderRadius: 10, alignItems: 'center' }}>
                <Image source={require("../static/logo.png")} style={{ width: "35%", height: "32%", marginTop: "10%" }}></Image>
                <TouchableOpacity onPress={() => { inputRef.current.focus() }} activeOpacity={0.6} style={{ width: "100%" }}>
                    <TextInput ref={inputRef} style={{
                        ...
                        color: "#FFFFFF",
                        alignSelf: "flex-end"
                    }} editable placeholder="Pincode" placeholderTextColor="#ffffff"
